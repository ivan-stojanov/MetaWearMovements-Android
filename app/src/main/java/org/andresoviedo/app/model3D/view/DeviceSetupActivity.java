...
public class DeviceSetupActivity extends AppCompatActivity implements ServiceConnection, org.andresoviedo.app.model3D.view.DeviceSetupActivityFragment.FragmentSettings {
    public final static String EXTRA_BT_DEVICE= "org.andresoviedo.app.model3D.view.DeviceSetupActivity.EXTRA_BT_DEVICE";

    public static class ReconnectDialogFragment extends DialogFragment implements  ServiceConnection {
        private static final String KEY_BLUETOOTH_DEVICE = "org.andresoviedo.app.model3D.view.DeviceSetupActivity.ReconnectDialogFragment.KEY_BLUETOOTH_DEVICE";
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            reconnectDialog.setButton(BUTTON_NEGATIVE, getString(android.R.string.cancel), new DialogInterface.OnClickListener() {
                @Override
            ...
            public void disconnected(int status) {
                ...
                metawear.connectAsync().continueWithTask(new Continuation<Void, Task<Void>>() {
                    ...
                    public Task<Void> then(Task<Void> task) throws Exception {
                        return task.isCancelled() || !task.isFaulted() ? task : SensorsActivity.reconnect(metawear);
                    }
