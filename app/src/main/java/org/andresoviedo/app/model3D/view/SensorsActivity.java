...
public class SensorsActivity extends AppCompatActivity implements BleScannerFragment.ScannerCommunicationBus, ServiceConnection {
        ...
        metawear.connectAsync().continueWithTask(new Continuation<Void, Task<Void>>() {
            ...
            public Void then(Task<Void> task) throws Exception {
                if (!task.isCancelled()) {
                    ...
                    Intent navActivityIntent = new Intent(SensorsActivity.this, DeviceSetupActivity.class);
